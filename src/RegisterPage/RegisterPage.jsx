...
class RegisterPage extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if (user.firstName && user.lastName && user.username && user.password && user.age && user.phoneNumber) {
            ...
            <div className="col-md-6 col-md-offset-3">
                ...
                <form name="form" onSubmit={this.handleSubmit}>
                    ...
                    <div className={'form-group' + (submitted && !user.username ? ' has-error' : '')}>
                        ...
                        <input type="text" className="form-control" type="email" name="username" value={user.username} onChange={this.handleChange} />
                    ...
                    <div className={'form-group' + (submitted && !user.phoneNumber ? ' has-error' : '')}>
                        ...
                        <input type="text" className="form-control" type="phoneNumber" name="phoneNumber" value={user.phoneNumber} onChange={this.handleChange} />
